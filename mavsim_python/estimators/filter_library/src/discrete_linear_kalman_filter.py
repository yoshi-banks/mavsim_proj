import numpy as np
from estimators.filter_library.src.utils import is_column_vector
...
class DiscreteLinearKalmanFilter:
    ...
    def predict(self, u, t, params, predictParams):
        """
        ...
        self.P_minus = F @ P @ F.T + Q
        self.x_hat_minus = F @ x + G @ u
        self.x_hat = self.x_hat_minus
        self.P = self.P_minus

    def update(self, z, u, t, params, updateParams):
        """
        ...
        self.P_plus = IKH @ P @ IKH.T + K @ R @ K.T
